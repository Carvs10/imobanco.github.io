  ...
  <div class="container">
    <div class="row justify-content-center">
      ...
      <div class="col-lg-6 text-left">
        ...
        <h4 class=" text-primary text-content">Com o Imobanco você gera, envia e administra todos os seus recebimentos e pagamentos.  Tudo online e em tempo real, de qualquer lugar do Brasil ou do mundo.</h4>
        <br>
